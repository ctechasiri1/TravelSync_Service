...
class TripRepository:
    ...
    async def get_trip(self, trip_id: int) -> models.Trip:
    ...
    async def delete_trip(self, user_id: int, trip_id: int) -> tuple[int, str] | None:
        delete_trip_query = (
            delete(models.Trip)
            .where(models.Trip.user_id == user_id, models.Trip.id == trip_id)
            .returning(models.Trip.id, models.Trip.cover_image)
        )
